...
Comp 3005 Project 2 - Health and Fitness Club System

Database Setup Steps
1) Install and Setup Postgres.
2) Create a new database called "Student".
3) Using the pgadmin query tool or similar run 'DDL.sql' from the 'SQL' folder.
4) Using the pgadmin query tool or similar run 'DML.sql' from the 'SQL folder'.
...
3) In Main.java navigate to lines 12,13,14, it is likely you will need to change at least the user and password strings, possibly also changing the port within the url string.
